...
const DEMO_STEPS: DemoStep[] = [
  {
    target: ['[data-demo-target="print-button"]'],
    eyebrow: 'Start here · 1 of 9',
    title: 'Print your schedule anytime',
    message: 'When your calendar is ready, click Print / Save PDF to print it or save a copy. You can use this button whenever you need the schedule on paper.',
    nextLabel: 'Next: start setup',
  },
  {
    target: ['[data-demo-target="setup-card"]'],
    eyebrow: 'Step 1 · 2 of 9',
  ...
  },
  {
    ...
    eyebrow: 'Last step · 9 of 9',
    title: 'Advanced features live here',
    message: 'More options contains the advanced features: saved schedules, printed titles, detailed editing, example data, and reset controls. Start with the simple setup above, and use these only when you need them.',
